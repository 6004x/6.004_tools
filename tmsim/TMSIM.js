var TMSIM = function(){
	...
	function developMachine(dict){
		...
		for (var i = 0; i < sortedKeys.length; i++){
			...
			var args  = dict[key]; //arguments coming after the list
