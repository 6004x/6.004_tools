(function() {
    ...
    MacroInvocation.prototype.assemble = function(context, out, source_map) {
        ...
        if (source_map) while (start_dot < context.dot) source_map[start_dot++] = this;
    };
    ...
    Expression.prototype.assemble = function(context, out, source_map) {
        ...
        if(out) {
            ...
            source_map[context.dot] = this;  // we'll want this.file and this.line
        }
        context.dot += 1;
    };
