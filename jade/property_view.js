...
var property_view = (function() {
    ...
    PropertyEditor.prototype.build_table = function() {
        ...
        for (var p in editor.module.properties) {
            ...
            tr.appendChild(td);
            field = jade_view.build_button('delete', function(event) {
            ...
            td = document.createElement('td');
            tr.appendChild(td);
            field = jade_view.build_input('text', 10, props.label || props.name);
            field.pname = p;
            field.props = props;
            ...
            td = document.createElement('td');
            tr.appendChild(td);
            field = jade_view.build_select(['string', 'menu'], props.type || 'string');
            field.props = props;
            $(field).change(function(event) {
            ...
            td = document.createElement('td');
            tr.appendChild(td);
            field = jade_view.build_input('text', 10, props.value || '');
            field.props = props;
            $(field).change(function(event) {
            ...
            td = document.createElement('td');
            tr.appendChild(td);
            field = jade_view.build_select(['yes', 'no'], props.edit || 'yes');
            field.props = props;
            $(field).change(function(event) {
            ...
            td = document.createElement('td');
            tr.appendChild(td);
            field = jade_view.build_input('text', 15, props.choices ? props.choices.join() : '');
            field.props = props;
            $(field).change(function(event) {
        ...
        var fields = {};
        fields.action = jade_view.build_button('add', function(event) {
        ...
        fields.name = jade_view.build_input('text', 10, '');
        fields.label = jade_view.build_input('text', 10, '');
        fields.type = jade_view.build_select(['string', 'menu'], 'string');
        fields.value = jade_view.build_input('text', 10, '');
        fields.edit = jade_view.build_select(['yes', 'no'], 'yes');
        fields.choices = jade_view.build_input('text', 15, '');
    ...
    jade_view.editors.push(PropertyEditor);
})();
