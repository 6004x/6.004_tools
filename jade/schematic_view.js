...
var schematic_view = (function() {
    ...
    function Schematic(div, jade) {
        ...
        this.toolbar = new jade_view.Toolbar(this.diagram);
        this.toolbar.add_tool('undo', jade_icons.undo_icon, 'Undo: undo effect of previous action', jade_view.diagram_undo,
                              function(diagram) {
                                  return diagram.aspect.can_undo();
                              });
        this.toolbar.add_tool('redo', jade_icons.redo_icon, 'redo: redo effect of next action', jade_view.diagram_redo,
                              function(diagram) {
        ...
        this.toolbar.add_tool('cut', jade_icons.cut_icon, 'Cut: move selected components from diagram to the clipboard', jade_view.diagram_cut, has_selections);
        this.toolbar.add_tool('copy', jade_icons.copy_icon, 'Copy: copy selected components into the clipboard', jade_view.diagram_copy, has_selections);
        this.toolbar.add_tool('paste', jade_icons.paste_icon, 'Paste: copy clipboard into the diagram', jade_view.diagram_paste,
                              function(diagram) {
                                  return jade_view.clipboards[diagram.editor.editor_name].length > 0;
                              });
        this.toolbar.add_tool('fliph', jade_icons.fliph_icon, 'Flip Horizontally: flip selection horizontally', jade_view.diagram_fliph, has_selections);
        this.toolbar.add_tool('flipv', jade_icons.flipv_icon, 'Flip Vertically: flip selection vertically', jade_view.diagram_flipv, has_selections);
        this.toolbar.add_tool('rotcw', jade_icons.rotcw_icon, 'Rotate Clockwise: rotate selection clockwise', jade_view.diagram_rotcw, has_selections);
        this.toolbar.add_tool('rotccw', jade_icons.rotccw_icon, 'Rotate Counterclockwise: rotate selection counterclockwise', jade_view.diagram_rotccw, has_selections);
        this.toolbar.add_spacer();

        // are we supporting hierarchy?
        this.hierarchy = (parent.input_field !== undefined);
        if (this.hierarchy) {
            this.toolbar.add_tool('down', jade_icons.down_icon, 'Down in the hierarchy: view selected included module', schematic_down,
                                  function(diagram) {
            ...
            this.toolbar.add_tool('up', jade_icons.up_icon, 'Up in the hierarchy: return to including module', schematic_up,
                                  function(diagram) {
        ...
        var part = this.toolbar.add_tool('ground', jade_icons.ground_icon, 'Ground connection: click and drag to insert', null, function() { return true; });
        part_tool(part,div.diagram,'ground');

        part = this.toolbar.add_tool('vdd', jade_icons.vdd_icon, 'Power supply connection: click and drag to insert', null, function() { return true; });
        part_tool(part,div.diagram,'vdd');

        part = this.toolbar.add_tool('port', jade_icons.port_icon, 'I/O Port: click and drag to insert', null, function() { return true; });
        part_tool(part,div.diagram,'port');

        part = this.toolbar.add_tool('jumper', jade_icons.jumper_icon, 'Jumper for connecting wires with different names: click and drag to insert', null, function() { return true; });
        part_tool(part,div.diagram,'jumper');

        part = this.toolbar.add_tool('text', jade_icons.text_icon, 'Text: click and drag to insert', null, function() { return true; });
    ...
    function part_tool(tool,diagram,pname) {
        ...
        part.set_component(jade_model.make_component([pname,[0,0,0],{}]));
    ...
    jade_view.editors.push(Schematic);
    ...
    function schematic_mouse_down(event) {
        ...
        if (diagram.pan_zoom(event)) return false;
        ...
        if (dx <= jade_model.connection_point_radius && dy <= jade_model.connection_point_radius && cplist && !event.shiftKey) {
            diagram.unselect_all(-1);
    ...
    Wire.prototype = new jade_model.Component();
    Wire.prototype.constructor = Wire;
    jade_model.built_in_components.wire = Wire;
    var wire_module = {
    ...
    Wire.prototype.move_end = function() {
        jade_model.Component.prototype.move_end.call(this);
    ...
    Wire.prototype.add = function(aspect) {
        jade_model.Component.prototype.add.call(this, aspect);
    ...
    Wire.prototype.remove = function() {
        ...
        for (var i = 0; i < cplist.length; i += 1) {
            ...
            if (w.type == 'wire' && w.other_end(cp1).coincident(cp2.x, cp2.y)) {
                jade_model.Component.prototype.remove.call(w);
                break;
            }
        }
    };
    ...
    Ground.prototype = new jade_model.Component();
    Ground.prototype.constructor = Ground;
    jade_model.built_in_components.ground = Ground;
    var ground_module = {
        has_aspect: function () {return false;},
    ...
    Vdd.prototype = new jade_model.Component();
    Vdd.prototype.constructor = Vdd;
    jade_model.built_in_components.vdd = Vdd;
    var vdd_module = {
        has_aspect: function () {return false;},
    ...
    Jumper.prototype = new jade_model.Component();
    Jumper.prototype.constructor = Jumper;
    jade_model.built_in_components.jumper = Jumper;
    var jumper_module = {
        has_aspect: function () {return false;}
    };
    ...
    Port.prototype = new jade_model.Component();
    Port.prototype.constructor = Port;
    jade_model.built_in_components.port = Port;
    var port_module = {
        has_aspect: function () {return false;},
    ...
    Text.prototype = new jade_model.Component();
    Text.prototype.constructor = Text;
    Text.prototype.required_grid = 1;
    jade_model.built_in_components.text = Text;
    var text_module = {
        has_aspect: function () {return false;},
        properties: {
            "text": {
    ...
    Text.prototype.edit_properties = function(diagram, x, y) {
        return jade_model.Component.prototype.edit_properties.call(this, diagram, x, y, function(c) {
    ...
    jade_model.ConnectionPoint.prototype.display_voltage = function(diagram, vmap) {
    ...
    jade_model.Component.prototype.display_current = function(diagram, vmap) {
            ...
            if (netlist.length > 0 && tstop !== undefined) {
                ...
                cktsim.transient_analysis(netlist,tstop,probe_names,function(percent_complete,results) {
                    if (results === undefined) {
                        ...
                        jade_view.window_close(progress.win); // all done with progress bar
