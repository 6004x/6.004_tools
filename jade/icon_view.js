...
var icon_view = (function() {
    ...
    function Icon(div, jade) {
        ...
        this.modes = {};
        this.modes.select = this.toolbar.add_tool('select', jade_icons.select_icon, 'Select mode', icon_select);
        this.set_mode('select');
        this.modes.line = this.toolbar.add_tool('line', jade_icons.line_icon, 'Icon line mode', icon_line);
        this.modes.arc = this.toolbar.add_tool('arc', jade_icons.arc_icon, 'Icon arc mode', icon_arc);
        this.modes.circle = this.toolbar.add_tool('circle', jade_icons.circle_icon, 'Icon circle mode', icon_circle);
        this.modes.text = this.toolbar.add_tool('text', jade_icons.text_icon, 'Icon text mode', icon_text);
        this.modes.terminal = this.toolbar.add_tool('terminal', jade_icons.terminal_icon, 'Icon terminal mode', icon_terminal);
        this.modes.property = this.toolbar.add_tool('property', jade_icons.property_icon, 'Icon property mode', icon_property);
    ...
    Icon.prototype.set_mode = function(mode) {
        ...
        var c = jade_model.built_in_components[mode];
    ...
    function icon_new_component(diagram) {
        ...
        var c = jade_model.make_component([editor.mode, [editor.start_x, editor.start_y, 0]]);
    ...
    Line.prototype = new jade_model.Component();
    Line.prototype.constructor = Line;
    Line.prototype.required_grid = 1;
    jade_model.built_in_components.line = Line;
    var line_module = {
        properties: {}
    };
    ...
    Arc.prototype = new jade_model.Component();
    Arc.prototype.constructor = Arc;
    Arc.prototype.required_grid = 1;
    jade_model.built_in_components.arc = Arc;
    var arc_module = {
        properties: {}
    };
    ...
    Circle.prototype = new jade_model.Component();
    Circle.prototype.constructor = Circle;
    Circle.prototype.required_grid = 1;
    jade_model.built_in_components.circle = Circle;
    var circle_module = {
        properties: {}
    };
    ...
    Property.prototype = new jade_model.Component();
    Property.prototype.constructor = Property;
    Property.prototype.required_grid = 1;
    jade_model.built_in_components.property = Property;
    var property_module = {
        properties: {
            "format": {
                "type": "string",
            ...
            "align": {
                ...
                "value": "center-left",
                "edit": "yes",
                "choices": schematic_view.text_alignments
            }
        }
    };
    ...
    Property.prototype.load = function(json) {
        ...
        this.bounding_box = schematic_view.text_bbox(this.properties.format, this.properties.align, '5pt sans-serif');
        this.update_coords();
    };
    ...
    Terminal.prototype = new jade_model.Component();
    Terminal.prototype.constructor = Terminal;
    Terminal.prototype.required_grid = 8;
    jade_model.built_in_components.terminal = Terminal;
    var terminal_module = {
        properties: {
            "name": {
                "type": "string",
    ...
    Terminal.prototype.load = function(json) {
        ...
        this.bounding_box = [-jade_model.connection_point_radius, - jade_model.connection_point_radius,
                             8 + jade_model.connection_point_radius, jade_model.connection_point_radius];
        this.update_coords();
    };
    ...
    Terminal.prototype.draw = function(diagram) {
        this.draw_circle(diagram, 0, 0, jade_model.connection_point_radius, false);
        if (this.properties.line != 'no') this.draw_line(diagram, 0, 0, 8, 0);
        this.draw_text(diagram, this.properties.name, jade_model.connection_point_radius - 4, 0, 5, diagram.property_font);
    };
